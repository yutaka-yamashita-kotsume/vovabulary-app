...
# docker build -t yutaka_vovabulary_app .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name yutaka_vovabulary_app yutaka_vovabulary_app
